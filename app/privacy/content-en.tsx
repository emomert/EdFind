/**
 * English body of the Privacy Policy. Long-form legal prose is kept as plain
 * JSX per locale (see content-tr.tsx) rather than as one giant JSON string —
 * see docs/features/i18n.md "long-prose strategy". Shared chrome (title,
 * intro, "last updated") lives in the `legal` message namespace.
 */
